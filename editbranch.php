                        ...
                        <div class="card-body car_img px-0 pb-2">
                            <form class="form_data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">                                     
                                        <label>Related Name & Surname</label>
                                        <input type="text" class="form-control" placeholder="Enter Related Name & Surname">
                                    </div>
                                    <div class="col-md-6">                                     
                                        <label>Related Phone Number</label>
                                        <input type="number" class="form-control" placeholder="Enter Related Phone Number">
                                    </div>
                                    <div class="col-md-6">                                     
                                    ...
                                    <div class="col-md-6">                                     
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Tax Number">
                                    </div>
                                    <div class="col-md-6">                                     
                                    ...
                                    <div class="col-md-6">                                     
                                        <label>Mail Send Limit</label>
                                        <input type="text" class="form-control" placeholder="Mail Send Limit">
                                    </div>
                                    <div class="col-md-6">                                     
