                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-2">
                                    <a href="addstaff.php"><button type="button" class="btn btn-dark add_btn">Add Staff</button></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                               <a href="editstaff.php"><button type="button" class="btn btn-dark btn-sm action action2">Edit</button></a>
