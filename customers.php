                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-2">
                                    <a href="addcustomer.php"><button type="button" class="btn btn-dark add_btn">Add Customer</button></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                               <!-- <a href="#"><button type="button" class="btn btn-success btn-sm action">Appointment Details</button></a> -->
                                                <a href="editcustomer.php"><button type="button" class="btn btn-dark btn-sm action action2">Edit</button></a>
