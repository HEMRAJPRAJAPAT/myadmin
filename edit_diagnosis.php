                            ...
                            <form class="form_data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Diagnosis Name">
                                    </div>
                                    <div class="col-md-6">                                     
                                    ...
                                    <div class="col-md-6">
                                        <label>Patient Loyalty Score</label>
                                        <input type="text" class="form-control" placeholder="Enter Patient Loyalty Score">
                                    </div>
                                    <div class="col-md-12">
