                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-2">
                                    <a href="addbranch.php"><button type="button" class="btn btn-dark add_btn">Add Branch</button></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>9462586485</td>
                                            <td>
                                               <a href="editbranch.php"><button type="button" class="btn btn-dark btn-sm action action2">Edit</button></a>
