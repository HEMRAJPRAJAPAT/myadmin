                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-2">
                                    <a href="addcustomerloyalty.php"><button type="button" class="btn btn-dark add_btn">Add Loyalty</button></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>12</td>
                                            <td>
                                               <a href="editcustomerloyalty.php"><button type="button" class="btn btn-dark btn-sm action action2">Edit</button></a>
